...
<form action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ) ?>" class="cart" method="post" enctype='multipart/form-data'>
	...
	<!--<h2 class="tribe-events-tickets-title"><?php esc_html_e( 'Register For', 'event-tickets-plus' ) ?> <?php the_title();?></h2>-->

	<div class="tribe-events-tickets">
		<?php
		foreach ( $tickets as $ticket ) {
			...
			if ( $ticket->date_in_range( current_time( 'timestamp' ) ) ) {
				...
				echo '<div class="large-9 columns"><ul class="event-ticket_wrap">';
				...
				$is_there_any_product_to_sell = true;
					...
					echo '<li>' . esc_html__( 'Out of stock!', 'event-tickets-plus' ) . '</li>';
				}
